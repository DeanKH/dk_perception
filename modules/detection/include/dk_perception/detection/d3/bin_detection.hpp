...
class BinDetectionLukas2022Heuristic {
 public:
  template <typename PointsTraits = pcl::PointCloud<pcl::PointXYZRGB>,
            typename IteratablePointsReadOnlyAccessor =
                dklib::perception::type::pointcloud::IteratableColorizedPointCloudReadOnlyAccessor<PointsTraits>>
  void detect(const IteratablePointsReadOnlyAccessor& pointcloud) {}
